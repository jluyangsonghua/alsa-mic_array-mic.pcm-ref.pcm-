...
LOCAL_CFLAGS := \
	...
	-finline-limit=300 -finline-functions -Wno-unused-parameter \
	-Wno-tautological-constant-out-of-range-compare -Wno-pointer-arith -Wno-logical-not-parentheses -Wno-enum-conversion -Wno-sign-compare
#LOCAL_CFLAGS += -DREFINE_DEBUG
